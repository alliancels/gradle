...
abstract class IarArmNativeCompilerTest extends NativeCompilerTest {
    ...
    protected List<String> getCompilerSpecificArguments(File includeDir) {
        [ '-c', '-I', '-Dfoo=bar', '-Dempty', '-firstArg', '-secondArg', includeDir.absoluteFile.toString() ]
    }

    def "arguments include IAR ARM output flag and output file name"() {
        given:
