...
public class Assembler extends IarArmNativeCompiler<AssembleSpec>  {
    ...
    private static class AssemblerArgsTransformer extends IarArmAssemblerArgsTransformer<AssembleSpec> {
    }
}
