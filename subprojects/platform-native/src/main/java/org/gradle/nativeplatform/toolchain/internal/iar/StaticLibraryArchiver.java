...
public class StaticLibraryArchiver implements Compiler<StaticLibraryArchiverSpec> {
    ...
    StaticLibraryArchiver(BuildOperationProcessor buildOperationProcessor, CommandLineToolInvocationWorker commandLineToolInvocationWorker, CommandLineToolContext invocationContext, Transformer<StaticLibraryArchiverSpec, StaticLibraryArchiverSpec> specTransformer) {
    ...
    public WorkResult execute(final StaticLibraryArchiverSpec spec) {
        ...
        new IarArmOptionsFileArgsWriter(spec.getTempDir()).execute(args);
    ...
    private static class LibExeSpecToArguments implements ArgsTransformer<StaticLibraryArchiverSpec> {
        ...
        public List<String> transform(StaticLibraryArchiverSpec spec) {
            ...
            args.add("-o" + spec.getOutputFile().getAbsolutePath());
            return args;
        }
    }
}
