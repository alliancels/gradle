...
public class DefaultIarArmPlatformToolChain implements IarArmPlatformToolChain {
    private final NativePlatform platform;
    protected final Map<ToolType, CommandLineToolConfigurationInternal> tools;

    public DefaultIarArmPlatformToolChain(NativePlatform platform, Instantiator instantiator) {
