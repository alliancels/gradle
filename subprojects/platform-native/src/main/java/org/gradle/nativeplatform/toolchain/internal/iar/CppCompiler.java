...
public class CppCompiler extends IarArmNativeCompiler<CppCompileSpec> {
    ...
    private static class CppCompilerArgsTransformer extends IarArmCompilerArgsTransformer<CppCompileSpec> {
        @Override
